...
public class MusicAdapterOld extends RecyclerView.Adapter<MusicAdapterOld.ViewHolder> {
    ...
    public MusicAdapterOld(List<Music> musicModelList, int rowLayout, Context context) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                musicListFiltered = (ArrayList<Music>) filterResults.values;
...
//     viewHolder.movieImage.setOutlineProvider(ViewOutlineProvider.BACKGROUND);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        public interface MusicAdapterListener {
            void onMusicModelSelected(Music contact);
        }
